...
(function() {
        ...
        render_md_vis.step = 1;
        render_md_vis.showvel = false;
        ...
        render_md_vis.traj_data = {};
        render_md_vis.setup = function() {

            d3.json("data/2dtrajectory.json", function(traj_data) {
                render_md_vis.traj_data = traj_data;
                render_md_vis.render();
            });
        };
        render_md_vis.render = function() {
            var svg = d3.select("#md-vis");
            ...
            svg.html('<defs>' +
                ...
                '    </marker>' +
                '</defs>');
            var frame_data = render_md_vis.traj_data[render_md_vis.step];
            ...
            node.append('circle')
                .attr("r", function(d, i) {
                    return Math.sqrt(aminoprops[frame_data.element[i] - 5].molWeight);
                })
                .attr("cx", 0)
                .attr("cy", 0);
            node.append('text')
